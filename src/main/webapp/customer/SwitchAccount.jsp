...
<body>
	<div class="navbar-home">
		...
		<div>
			<li><a href="<%=request.getContextPath()%>/customer/account.jsp"
		...
		<c:forEach var="accounts" items="${accountsList}">
			<div class="account-details"
				...
				<div class="account-logo">
					<img src="images/AccountLogo.png" alt="Account Logo">
				</div>
				<table>
					<tr>
						<th>Account Id</th>
				...
				<form id="form${accounts.accountNumber}"
					action="<%=request.getContextPath()%>/changeAccount" method="post">
